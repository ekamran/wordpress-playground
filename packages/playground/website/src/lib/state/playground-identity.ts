 ...
 * site's boot process.
 *
 * PHP constants are omitted because autosave can discover and persist them
 * after the iframe has already booted with those constants. Updating the stored
 * copy should not restart an otherwise identical running Playground.
 */
